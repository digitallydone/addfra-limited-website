      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-4 gap-2">
              {product.images?.slice(0, 4).map((image, index) => (
                <div key={index} className="border rounded-md overflow-hidden h-24 cursor-pointer">
                  <img
              ...
              {Array.from({ length: Math.max(0, 4 - (product.images?.length || 0)) }).map((_, index) => (
                <div key={`placeholder-${index}`} className="border rounded-md overflow-hidden h-24 bg-slate-100"></div>
              ))}
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex items-baseline">
                ...
                {product.comparePrice && product.comparePrice > product.price && (
                  <span className="ml-2 text-lg text-slate-500 line-through">${product.comparePrice.toFixed(2)}</span>
                )}
              </div>
              {product.comparePrice && product.comparePrice > product.price && (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4">
              <div className="flex flex-col items-center text-center p-3 border rounded-md">
                ...
                <span className="text-xs text-slate-500">On orders over $500</span>
              </div>
              <div className="flex flex-col items-center text-center p-3 border rounded-md">
                <Shield className="h-6 w-6 text-primary mb-2" />
                <span className="text-sm font-medium">Warranty</span>
                <span className="text-xs text-slate-500">1 Year manufacturer warranty</span>
              </div>
              <div className="flex flex-col items-center text-center p-3 border rounded-md">
        ...
        <div className="mt-16">
          <Tabs defaultValue="specifications">
            ...
            <TabsContent value="specifications" className="p-6 border rounded-md mt-4">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-slate-700">
                    We ship to all major cities in Ghana and neighboring countries. Standard shipping takes 3-5 business
                    days within Ghana, and 7-14 business days for international orders.
                  </p>
                ...
                <div>
                  ...
                  <p className="text-slate-700">
                    We offer a 30-day return policy for most items. Products must be returned in original packaging and
                    in unused condition.
                  </p>
                  <ul className="list-disc list-inside mt-2 text-slate-700">
                    <li>30-day return window from date of delivery</li>
                    <li>Refunds processed within 7-10 business days</li>
                    <li>Buyer responsible for return shipping costs unless item is defective</li>
                  </ul>
                </div>
              </div>
            </TabsContent>
            <TabsContent value="reviews" className="p-6 border rounded-md mt-4">
              <div className="text-center py-8">
                ...
                <p className="text-slate-700 mb-4">Be the first to review this product</p>
